...
public class DataPahlawan {
    private static String[] namaPahlawan = new String[] {
            "Ir. Soekarno",
            "Drs. Moh Hatta",
            "Jendral Soedirman",
            "Ki Hajar Dewantara",
    ...
    private static String[] detailPahlawan = new String[] {
    ...
    public static ArrayList<PahlawanModel> getHeroList(){
        ...
        for (int i = 0; i < namaPahlawan.length; i++){
            ...
            pahlawanModel.setNama(namaPahlawan[i]);
            pahlawanModel.setDetail(detailPahlawan[i]);
            pahlawanModel.setFotoPahlawan(fotoPahlawan[i]);
